                        ...
                        <div className="col-span-4 sm:col-span-3">
                            <div className="bg-white shadow rounded-lg p-6">
                                <div className="flex flex-col items-center">
                                    <Image src={customer.image_url} className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0" alt={`${customer.name}'s profile picture`} width={32} height={32} />
                                    <h1 className="text-xl font-bold">{customer.name}</h1>
                                    <p className="text-gray-700">{customer.email}</p>
                                    <div className="mt-6 flex flex-wrap gap-4 justify-center">
                                        <UpdateCustomer id={customer.id} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded" />
                                        <DeleteCustomer id={customer.id} className="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded"/>
                                    </div>
                                </div>
